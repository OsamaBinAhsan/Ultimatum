...
export default function HomePage() {
  ...
  return (
    <div className="space-y-10 sm:space-y-14 lg:space-y-16 pb-16 sm:pb-20">
      {/* 1. HERO SPOTLIGHT */}
      <section className="relative overflow-hidden pt-2 sm:pt-4 md:pt-6">
        <div className="mx-auto max-w-7xl px-3 sm:px-6 lg:px-8">
          <div className="relative overflow-hidden rounded-3xl border border-zinc-800 bg-gradient-to-br from-zinc-900 via-zinc-950 to-black p-5 sm:p-8 md:p-10 xl:p-12 shadow-2xl">
            {/* Ambient Glow */}
            ...
            <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 xl:gap-10 items-center">
              <div className="lg:col-span-7 space-y-3.5 sm:space-y-5">
                <div className="inline-flex items-center gap-2 rounded-full border border-cyan-500/30 bg-cyan-500/10 px-3 py-1 sm:px-3.5 sm:py-1.5 text-[10px] sm:text-xs font-mono font-semibold text-cyan-300">
                  <Sparkles className="w-3.5 h-3.5" />
                  <span>THE PREMIER LIFESTYLE & GAMING HUB</span>
                </div>

                <h1 className="text-2xl sm:text-4xl lg:text-4xl xl:text-5xl 2xl:text-6xl font-black tracking-tight text-white leading-[1.15] sm:leading-[1.1]">
                ...
                <div className="grid grid-cols-2 sm:flex sm:flex-wrap items-center gap-2 sm:gap-2.5 pt-1">
                  <Link
                    href="/games/neon-asteroid-blitz"
                    className="col-span-2 sm:col-span-1 flex items-center justify-center gap-2.5 rounded-2xl bg-gradient-to-r from-cyan-500 to-blue-600 px-5 sm:px-6 py-3 text-xs sm:text-sm font-bold text-white shadow-xl shadow-cyan-500/25 hover:from-cyan-400 hover:to-blue-500 transition-all hover:scale-105 tap-target"
                  >
                  ...
                  <Link
                    href="/recipes"
                    className="flex items-center justify-center gap-2 rounded-2xl border border-zinc-700 bg-zinc-900/80 px-4 sm:px-5 py-3 text-xs sm:text-sm font-bold text-zinc-200 hover:bg-zinc-800 hover:text-white transition-all tap-target"
                  >
                  ...
                  <Link
                    href="/news"
                    className="col-span-2 sm:col-span-1 flex items-center justify-center gap-2 rounded-2xl border border-zinc-700 bg-zinc-900/80 px-4 sm:px-5 py-3 text-xs sm:text-sm font-bold text-zinc-200 hover:bg-zinc-800 hover:text-white transition-all tap-target"
                  >
              ...
              <div className="lg:col-span-5">
                <div className="relative overflow-hidden rounded-2xl border border-zinc-700 bg-zinc-900 p-4 sm:p-5 shadow-2xl group">
                  <div className="relative aspect-video w-full overflow-hidden rounded-xl">
                    ...
                    />
                    <div className="absolute top-3 left-3 rounded-full bg-cyan-950/90 border border-cyan-500/50 px-2.5 sm:px-3 py-1 text-[10px] sm:text-[11px] font-mono font-bold text-cyan-300">
                      FEATURED GAME
                    </div>
                  </div>
                  ...
                  <div className="mt-4 space-y-2">
                    <div className="flex items-center justify-between">
                      <h3 className="text-lg sm:text-xl font-bold text-white truncate mr-2">{featuredGame.title}</h3>
                    ...
                    <Link
                      ...
                      className="mt-3 flex items-center justify-center gap-2 rounded-xl bg-cyan-500 py-2.5 sm:py-3 text-xs font-bold text-zinc-950 hover:bg-cyan-400 transition-colors tap-target"
                    >
      ...
      <section className="mx-auto max-w-7xl px-3 sm:px-6 lg:px-8">
        <div className="rounded-3xl border border-amber-500/30 bg-gradient-to-r from-zinc-950 via-amber-950/20 to-zinc-950 p-5 sm:p-8 flex flex-col md:flex-row items-start md:items-center justify-between gap-6 shadow-xl">
          <div className="flex items-start sm:items-center gap-3.5 sm:gap-4">
            ...
            <div>
              ...
              <h3 className="text-base sm:text-lg font-bold text-white mt-0.5">Earn Engagement XP While You Read & Play</h3>
          ...
          <div className="flex items-center gap-3 w-full md:w-auto">
            <Link
              href="/games"
              className="w-full md:w-auto text-center rounded-xl bg-amber-500 px-5 py-3 sm:py-2.5 text-xs font-bold text-zinc-950 hover:bg-amber-400 transition-all shadow-md shadow-amber-500/20 tap-target flex items-center justify-center"
            >
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-8">
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 border-b border-zinc-800 pb-4">
          <div>
            ...
            <h2 className="text-3xl font-black text-white tracking-tight">Featured Arcade Games</h2>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="rounded-3xl border border-zinc-800 bg-zinc-900/80 p-6 shadow-xl space-y-4">
            ...
            <Link
              href="/games"
              className="mt-2 flex items-center justify-center gap-2 rounded-xl bg-zinc-800 py-2.5 text-xs font-bold text-zinc-200 hover:bg-zinc-700 transition-colors tap-target"
            >
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="rounded-3xl border border-zinc-800 bg-zinc-900/70 p-6 sm:p-8 space-y-4 shadow-xl">
          ...
          <Link
            ...
            className="flex items-center justify-center gap-2 rounded-xl bg-amber-500 py-3 text-xs font-bold text-zinc-950 hover:bg-amber-400 transition-colors tap-target"
          >
        ...
        <div className="rounded-3xl border border-zinc-800 bg-zinc-900/70 p-6 sm:p-8 space-y-4 shadow-xl">
          ...
          <Link
            ...
            className="flex items-center justify-center gap-2 rounded-xl bg-indigo-600 py-3 text-xs font-bold text-white hover:bg-indigo-500 transition-colors tap-target"
          >
